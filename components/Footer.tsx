            ...
            <div className="justify-between items-center gap-12 md:flex">
                <div className="flex-1 max-w-lg">
                    <h3 className="text-myblack text-2xl font-bold">
                        Souscrivez a notre Newletters et restez informer de toute nos promotions et sorties.
                    </h3>
                </div>
                <div className="flex-1 mt-6 md:mt-0">
                    <form className="flex items-center gap-x-3 md:justify-end">
                        ...
                        <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-[#4A050D] hover:bg-redhot active:bg-indigo-700 active:shadow-none rounded-lg shadow">
                            Souscrire
                        </button>
                    </form>
                </div>
            ...
            <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
                {
                    footerNavs.map((item, idx) => (
                        <ul
                            className="space-y-4 text-myblack"
                            key={idx}
                        >
                            <h4 className="text-myblack font-semibold sm:pb-2">
                                {item.label}
                            </h4>
                            {
                                item.items.map(((el, idx) => (
                                    <li key={idx}>
                                        <a
                                            href={el.href}
                                            className="duration-150 hover:text-redhot"
