...
export default function Spiritueux() {
    ...
    const handleAddToCart = (spiritueux: SpiritueuxInterface) => {
        ...
        if (cartItems) {
            const existingCartItemIndex = cartItems.findIndex(item => item.id === spiritueux.id);
                                ...
                                <div className="grid justify-center">
                                    <div key={index} className="group border-gray-100/30 flex w-full max-w-xs flex-col self-center overflow-hidden rounded-3xl border bg-rock-800 shadow-md mb-12 ">
                                        ...
                                        <div className="mt-4 px-5 pb-5 bg-transparent">
                                            ...
                                            <a onClick={() => handleAddToCart(spiritueux)} className="hover:border-white/40 flex cursor-pointer items-center justify-center rounded-md border border-transparent bg-[#4A050D] px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-redhot">
