// app/champagnes/ChampagneList.tsx
"use client";
...
export default function ChampagneList({ initialChampagnes } : { initialChampagnes : Champagne[]}) {
  const [champagnes, setChampagnes] = useState(initialChampagnes);
