                                ...
                                <div className="grid justify-center">
                                    ...
                                    <a className="relative bg-white mx-3 mt-3 flex h-60 overflow-hidden rounded-2xl" href={`champagnes/${champagne.id}`}>
                                        ...
                                        <div className="mt-4 px-5 pb-5 bg-transparent">
                                            ...
                                            <a onClick={() => handleAddToCart(champagne)} className="hover:border-white/40 flex items-center justify-center cursor-pointer rounded-md border border-transparent bg-[#4A050D] px-5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-redhot">
